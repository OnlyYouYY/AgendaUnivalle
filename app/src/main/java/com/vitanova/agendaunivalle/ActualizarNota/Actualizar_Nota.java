package com.vitanova.agendaunivalle.ActualizarNota;
...
public class Actualizar_Nota extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    TextView Id_nota_A,Uid_Usuario_A,Correo_Usuario_A,Fecha_hora_registro_A,Fecha_A,Estado_A,Estado_nuevo;
    ...
    private void SetearDatos(){
        ...
        Fecha_hora_registro_A.setText(fecha_hora_registro_R);
